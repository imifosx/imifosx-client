(function (module) {
    mifosX.controllers = _.extend(module, {
        IjaraController: function ($q, scope, routeParams, route, location, resourceFactory) {
            scope.group = [];
            scope.tempData = [];
    ...
    mifosX.ng.application.controller('IjaraController', ['$q', '$scope', '$routeParams', '$route', '$location', 'ResourceFactory',
        mifosX.controllers.IjaraController]).run(function ($log) {
